        ...
        <div className="px-5 py-4 border-b border-stone-200 bg-white flex items-center justify-between sticky top-0 z-10">
          <div>
            <div className="flex items-center gap-2">
              ...
              {isAiPrefilled && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-semibold bg-stone-900 text-white">
        ...
        <form onSubmit={handleSubmit} className="p-5 sm:p-6 overflow-y-auto space-y-5 flex-1">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-stone-700">
              店名 <span className="text-orange-600">*</span>
            </label>
            <input
              id="input-spot-name"
              type="text"
              ...
              className={`w-full px-3.5 py-2 bg-white border ${
                errors.name ? 'border-orange-500 ring-1 ring-orange-500' : 'border-stone-200'
              } rounded-lg text-sm focus:outline-none focus:border-stone-900`}
            />
            {errors.name && <p className="text-xs text-orange-600">{errors.name}</p>}
          </div>
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-stone-700 flex items-center gap-1">
              ...
              おすすめしてくれた人 <span className="text-orange-600">*</span>
            </label>
            <input
              ...
              className={`w-full px-3.5 py-2 bg-white border ${
                errors.recommender ? 'border-orange-500 ring-1 ring-orange-500' : 'border-stone-200'
              } rounded-lg text-sm focus:outline-none focus:border-stone-900`}
            />
            {errors.recommender && <p className="text-xs text-orange-600">{errors.recommender}</p>}
          </div>
          ...
          <div className="bg-stone-50 rounded-xl p-4 border border-stone-200 space-y-3.5">
            ...
            <div className="pt-2 border-t border-stone-200 flex items-center justify-between">
              <span className="text-xs font-semibold text-stone-700 flex items-center gap-1.5">
                <Heart className={`w-3.5 h-3.5 ${isFavorite ? 'text-orange-600 fill-orange-600' : 'text-stone-400'}`} />
                お気に入りに追加する
              </span>
              <button
                type="button"
                ...
                className={`w-10 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer ${
                  isFavorite ? 'bg-orange-600' : 'bg-stone-300'
                }`}
              >
                <div
          ...
          <div className="pt-2">
            <button
              id="submit-spot-btn"
              type="submit"
              className="w-full py-3 rounded-xl bg-stone-900 hover:bg-stone-800 text-white font-semibold text-sm shadow-sm transition-all cursor-pointer"
            >
